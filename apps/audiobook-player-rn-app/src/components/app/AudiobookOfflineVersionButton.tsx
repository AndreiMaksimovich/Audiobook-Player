...
import OfflineAudiobookRemovalConfirmationModal from "@/src/components/app/OfflineAudiobookRemovalConfirmationModal";
import {removeOfflineAudiobook} from "@/src/store/Actions";
import {themeStyles} from "@/src/theme";

export interface AudiobookOfflineVersionButtonProps {
    audiobook: Audiobook
}

export default function AudiobookOfflineVersionButton(props: AudiobookOfflineVersionButtonProps) {
